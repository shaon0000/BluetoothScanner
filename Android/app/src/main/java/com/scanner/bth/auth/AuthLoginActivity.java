 ...
 */
public class AuthLoginActivity extends AccountAuthenticatorActivity {
    ...
    private AuthApi sServerAuthenticate;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Intent> {
        ...
        protected Intent doInBackground(Void... params) {
            ...
            String authtoken = sServerAuthenticate.userSignIn(mEmail, mPassword, mAuthTokenType, AuthLoginActivity.this);
    ...
    private void finishLogin(Intent intent) {
        ...
        if (getIntent().getBooleanExtra(ARG_IS_ADDING_NEW_ACCOUNT, false)) {
            Log.d(AuthLoginActivity.class.getSimpleName(), "adding a new account");
